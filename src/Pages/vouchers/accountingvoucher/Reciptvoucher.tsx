...
const Reciptvoucher: FC = () => {
    ...
    // keyboard handlers
    useEffect(() => {
        document.title = "Accounting payment voucher - SN ERP";
                    ...
                    <div className='my-2 border-b-2 border-gray-500'>
                        <div className='flex items-center justify-between'>
                            <div className='flex items-center'>
                                <h2 className='bg-red-600 px-4 text-white font-semibold'>Recipt</h2>
                        ...
                        <div className='mt-10 pl-5'>
                            <Select
                                ...
                                {...register("accounts")}
                            />
                            <p className='ml-4 italic'>Cur Bal:</p>


                        </div>
                    </div>
                    <div className='flex items-center justify-between font-bold pl-5 border-b-2 border-gray-500'>
                        <h1>Particulars</h1>
                        <h1>Amount</h1>
                    </div>
