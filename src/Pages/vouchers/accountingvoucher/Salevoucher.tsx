...
const Salevoucher: FC = () => {
    ...
    const Saleprtydetail = useWatch({
        control,
        name: "Salespartydetail",
    });

    useEffect(() => {
        if (Saleprtydetail === "Yes") {
            navigate("/sales-party-detail");
        }
    }, [Saleprtydetail, navigate]);
            ...
            <div className="min-h-screen bg-surface flex flex-col">
                ...
                <div className="w-full pt-10 flex items-center justify-between bg-gray-300">
                    <div>
                        <h1 className="capitalize text-black text-md  font-semibold">
                            Acounting voucher creation - sales Voucher
                        </h1>
                    </div>
                ...
                <form action=""
                    ...
                    <div className='my-2 pb-4 border-b-2 border-gray-500'>
                        <div className='flex items-center justify-between'>
                            <div className='flex items-center'>
                                <h2 className='bg-red-600 px-4 text-white font-semibold'>Sales</h2>
                        ...
                        <div className='mt-10 pl-5'>
                            <Select
                                label="Party`s A/c Name"
                                options={["NO", "Yes"]}
                                {...register("Salespartydetail")}
                            />
                    ...
                    <div className='flex items-center justify-between font-bold pl-12  border-b-2 border-gray-500'>
                        <h1>Name of items</h1>
                        <div className='flex items-center w-[30%] justify-start gap-24'>
                            <h1>Quality</h1>
                            <h1>Rate  per</h1>
                            <h1>Amount</h1>
                        </div>
