...
const Field = forwardRef<HTMLInputElement, FieldProps>(
  ({ label, hidelabel = false, error, className, type = "text", ...rest }, ref) => {
      ...
      <div className="flex flex-row justify-start items-center text-md ">
        ...
        <div className="w-full flex flex-row items-center justify-start">
          <input
            ...
            aria-invalid={!!error}
            className={`bg-gray-300 mr-5 focus:bg-black max-w-52 focus:text-white outline-none transition-colors text-[var(--text)] w-full ${error
