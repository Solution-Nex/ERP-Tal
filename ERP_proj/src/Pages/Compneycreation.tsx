...
const Section = ({ title, children }: { title: string; children: React.ReactNode }) => (
  <div className="mb-1">
    <h3 className="font-semibold text-center underline mb-2">{title}</h3>
    {children}
  </div>
);
...
const Compneycreation = () => {
 ...
 const [website, setwebsite] = useState("")
  ...
  return (
    <div className="flex-1 bg-[#d8f5d2] p-4 overflow-auto">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div>
          ...
          type="text" 
           onChange={(e) => setdirectory(e)} value={directory} 
           reqired={true}/>
          <Field label="Name" type="text"  onChange={(e) => setname(e)} value={name} reqired={true}/>

          {/* Primary Mailing Details Section */}
          <Section title="Primary Mailing Details">
            <Field label="Mailing name" type="text" onChange={(e) => setmalingname(e)} value={malingname} />
            <Field label="Address" type="text" onChange={(e) => setaddress(e)} value={address} />
            <Select
              label="Country"
            ...
            />
            <Field label="Pincode" type="text" value={pincode} onChange={(e)=> setpincode(e)} />
          </Section>

          {/* Contact Details Section */}
          <Section title="Contact Details">
            <Field label="Phone no." type="tel" onChange={(e)=> setphonenumber(e)} value={phonenumber} />
            <Field label="Mobile no." type="tel" onChange={(e)=> setmobilenumber(e)} value={mobilenumber} reqired={true}/>
            <Field label="Fax no." type="tel" onChange={(e)=> setfaxnumber(e)} value={faxnumber} />
            <Field label="E-mail" type="email" onChange={(e)=> setemail(e)} value={email} reqired={true}/>
            <Field label="Website" type="url" onChange={(e)=> setwebsite(e)} value={website} />
          </Section>
        </div>
        ...
        <div>
          ...
          <Section title="Books and Financial Year Details">
            <Field label="Financial year begins from" type="date" value={financialyear} onChange={(e) => setfinancialyear(e)}  reqired={true}/>
            <Field label="Books beginning from" type="date" value={booksbeginning} onChange={(e) => setbooksbeginning(e)} reqired={true} />
          </Section>

          {/* Security Control Section */}
          <Section title="Security Control">
            <Field label="TallyVault password (if any)" type="password" onChange={(e) => settallyvaultpassword(e)} value={tallyvaultpassword} />
            <Field label="Repeat password" type="password" onChange={(e) => setrepeatpassword(e)} value={repeatpassword} />
            <p className="text-md italic">
              (Warning: Forgetting TallyVault password will render your data inaccessible)
            </p>
            <Select
      ...
      <div className="mt-2 border-t border-green-700 pt-2">
        <h3 className="font-semibold text-center underline mb-2">Base Currency Information</h3>
        ...
        <div className="grid grid-cols-2 gap-8">
          <div>
            ...
            />
            <Field label="Formal name" type="text" value={formalname} onChange={(e)=> setformalname(e)}/>
            <Select
              label="Suffix symbol to amount"
              options={["Yes", "No"]}
              value={suffixsymboltoamount} onChange={(e) => setsuffixsymboltoamount(e)}
            />
            <Select
              label="Add space between amount and symbol"
              options={["Yes", "No"]}
              value={addspacebetweenamountandsymbol} onChange={(e) => setaddspacebetweenamountandsymbol(e)}
            />
            <Select
              label="Show amount in millions"
              options={["Yes", "No"]}
              value={showamountinmillions} onChange={(e) => setshowamountinmillions(e)}
            />
          </div>

          <div>
            <Field label="Number of decimal places" type="number" value={numberofdecimalplaces} onChange={(e) => setnumberofdecimalplaces(e)} />
            <Field label="Word after decimal" type="text" value={wordafterdecimal} onChange={(e) => setwordafterdecimal(e)} />
            <Field label="Decimal places in words" type="number" value={decimalplacesinwords} onChange={(e) => setdecimalplacesinwords(e)} />
          </div>
        </div>
      </div>
    </div>
